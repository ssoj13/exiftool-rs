...
- MakerNotes write: FujiFilm IFD fields overlay existing tags only (ExifTool Permanent), then AFCSettings int32u. Other IFD vendors patch in place. Nested Olympus/Pentax IFDs, Canon/Sony/Nikon index blobs, Sony Tag9405a, Kodak KDK Quality/BurstMode overlay when the parser table has the field. Unknown magics stay blobs.
