...
use exiftool_core::{writer::tags, ByteOrder, ExifWriter, WriteEntry};
...
fn minimal_jpeg() -> Vec<u8> {
    vec![
        // SOI
        0xFF, 0xD8, // APP0 JFIF
        0xFF, 0xE0, 0x00, 0x10, b'J', b'F', b'I', b'F', 0x00, 0x01, 0x01, 0x00, 0x00, 0x48, 0x00,
        0x48, 0x00, 0x00, // DQT (minimal)
...
fn round_trip_with_existing_exif() {
    ...
    assert_eq!(
        final_metadata.exif.get_str("Copyright"),
        Some("Copyright 2024")
    );
