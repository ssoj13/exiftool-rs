...
1. MakerNotes field write: IFD overlay uses vendor parser tag tables; Olympus sub-IFDs and Canon CameraSettings/ShotInfo int16 arrays overlay in place. DJI FLOAT, GoPro GPMF same-size leaves, Nikon encrypted overlay as before. Still blob-copy: NikonCustom ShotInfo bitfields, `KDK*`.
